...
import com.par9uet.jm.utils.removeSearchHistoryItem
...
class HistorySearchManager(
    ...
    fun removeItem(item: String) {
        val list = removeSearchHistoryItem(_historySearchState.value, item)
        if (list == _historySearchState.value) return
